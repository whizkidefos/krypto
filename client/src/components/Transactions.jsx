...
const TransactionsCard = ({ addressTo, addressFrom, timestamp, message, keyword, amount, url }) => {
  ...
  return (
    <article className="bg-[#181918] m-4 flex flex-1
      2xl:min-w-[450px]
      2xl:max-w-[500px]
      sm:min-w-[270px]
      sm:max-w-[300px]
...
const Transactions = () => {
    ...
    return (
        <section className='flex items-center justify-center w-full 2xl:px-20 gradient-bg-transactions'>
            <div className='flex flex-col px-4 md:p-12'>
                {currentAccount ? (
                    <h3 className="my-2 text-3xl text-center text-white">Latest Transactions</h3>
                ) : (
                    <h3 className="my-2 text-3xl text-center text-white">Connect your account to see the latest transactions</h3>
                )}
