...
const Footer = () => (
  <footer className="flex flex-col items-center justify-between w-full p-4 md:justify-center gradient-bg-footer">
    ...
    <div className="sm:w-[90%] w-full flex justify-between items-center mt-3">
      <a href="https://github.com/whizkidefos" target='_blank' className="text-xs text-left text-white">@whizkidefos</a>
      <p className="text-xs text-right text-white">&copy; 2022 - All rights reserved</p>
    </div>
  </footer>
);
