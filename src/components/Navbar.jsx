...
const NavbarItem = ({ title, classProps }) => {
    return (
        <li className={`mx-4 py-3 cursor-pointer ${classProps}`}>{title}</li>
    );
}
    ...
    return (
        <nav className="flex items-center justify-between w-full p-4 md:justify-center">
            ...
            <ul className="flex-row items-center justify-between flex-initial hidden text-white list-none md:flex">
                ...
                <li onClick={connectWallet} className="bg-[#2952e3] py-2 px-7 mx-4 rounded-full cursor-pointer hover:bg-[#2546bd]">Login</li>
            </ul>
            ...
            flex flex-col justify-start items-end rounded-md blue-glassmorphism text-white animate-slide-in"
                    >
                        <li className="w-full my-4 text-xl"><AiOutlineClose onClick={() => setToggleMenu(false)} /></li>
