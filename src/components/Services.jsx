...
const ServiceCard = ({ color, title, icon, subtitle }) => (
  <article className="flex flex-row items-center justify-start p-3 m-2 cursor-pointer white-glassmorphism hover:shadow-xl">
...
const Services = () => {
    return (
        <section className='flex items-center justify-center w-full gradient-bg-services'>
